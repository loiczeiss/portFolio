  ...
  return (
    <div className="contact_div">
      ...
      <div
        ...
        onMouseLeave={() => {
          setSVGstyle({ fill: "white", transition: "fill 0.3s" });
        }}
      >
        <svg
        ...
        >
          <g transform="translate(28 328)">
            <path d="M4-272.1c-13.2 0-23.9-10.7-23.9-23.9S-9.2-319.9 4-319.9s23.9 10.7 23.9 23.9S17.2-272.1 4-272.1zm0-45.2c-11.7 0-21.3 9.6-21.3 21.3s9.6 21.3 21.3 21.3 21.3-9.6 21.3-21.3-9.6-21.3-21.3-21.3z"></path>
