...
export default function Home() {
  ...
  return (
    <div
      className="flex flex-col sm:flex-row justify-between relative border border-black dark:border-white w-[calc(100%-40px)] sm:w-[calc(100%-120px)] h-[calc(100%-40px)] sm:h-[calc(100%-60px)] mx-auto mr-[26.8px] sm:ml-0 px-3 sm:pl-5 sm:pr-0 select-none z-10 overflow-hidden"
      id="frame">
      <div className="absolute top-0 left-0 w-full h-full z-[-1]" ref={myRef}></div>
      <div className="flex flex-col">
        <header className="mt-5">
          <h1 className="font-neueMontrealLight text-5xl sm:text-6xl mt-5 mb-1 text-black dark:text-white">Loïc
            Zeiss</h1>
