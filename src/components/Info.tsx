function Info() {
  ...
  return (
    <div className="self-end lg:self-center flex flex-col mr-5 font-neueMontreal sm:text-4xl lg:text-6xl text-2xl pb-8">
      <a
        className="sm:text-4xl lg:text-6xl text-2xl mt-2.5 mb-2.5 text-black dark:text-white hover:text-gray-500 dark:hover:text-gray-400 transition-colors duration-300"
      ...
      >
        <div className="flex flex-row items-center group">
          <svg
            ...
            className="fill-black dark:fill-white group-hover:fill-gray-500 dark:group-hover:fill-gray-400 transition-colors duration-300 h-8 w-8 sm:h-12 sm:w-12 lg:h-16 lg:w-16"
          >
